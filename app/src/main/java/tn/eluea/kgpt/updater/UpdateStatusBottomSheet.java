    ...
    private void setupView(View view) {
        ...
        switch (status) {
            case UPDATE_AVAILABLE:
                ...
                tvTitle.setText(R.string.update_available_title);

                if (updateInfo != null) {
                    tvMessage.setText(context.getString(R.string.update_app_desc, updateInfo.getVersionName(),
                            BuildConfig.VERSION_NAME));
                }

                btnPrimary.setText(R.string.btn_download);
                ...
                btnSecondary.setText(R.string.btn_later);
            ...
            case UP_TO_DATE:
                ...
                btnPrimary.setText(R.string.btn_great);
            ...
            case ERROR:
                ...
                tvTitle.setText(R.string.check_failed);

                tvMessage.setText(
                        context.getString(R.string.check_failed_desc, errorMessage != null ? errorMessage : ""));
                ...
                btnSecondary.setVisibility(View.VISIBLE);
                btnSecondary.setText(R.string.btn_close);
                btnSecondary.setOnClickListener(v -> dialog.dismiss());
                break;
            ...
            case NO_INTERNET:
                ...
                iconContainer
                        .setBackgroundTintList(android.content.res.ColorStateList.valueOf(colorSecondaryContainer));
                ...
                tvMessage.setText(R.string.no_internet_desc);

                btnPrimary.setText(R.string.btn_ok);
                btnPrimary.setIconResource(R.drawable.ic_check);
                btnPrimary.setOnClickListener(v -> dialog.dismiss());
