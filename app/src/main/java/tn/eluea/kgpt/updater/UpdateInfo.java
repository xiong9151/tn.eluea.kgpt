...
public class UpdateInfo {
    ...
    public String getFormattedFileSize() {
        ...
        if (fileSize < 1024 * 1024)
            return String.format(java.util.Locale.ROOT, "%.1f KB", fileSize / 1024.0);
        return String.format(java.util.Locale.ROOT, "%.1f MB", fileSize / (1024.0 * 1024.0));
    }
    ...
    public boolean isSecureDownload() {
        return downloadUrl != null && downloadUrl.toLowerCase(java.util.Locale.ROOT).startsWith("https://");
    }
