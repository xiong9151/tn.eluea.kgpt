...
public class BackupOptionsBottomSheet {
    ...
    private void setupViews(View view) {
        ...
        if (isRestore) {
            tvTitle.setText(R.string.restore_settings_title);
            tvDescription.setText(R.string.restore_settings_desc);
            ivIcon.setImageResource(R.drawable.ic_cloud_restore_arrow_filled);
            btnConfirm.setText(R.string.action_restore);
            btnConfirm.setIconResource(R.drawable.ic_cloud_restore_arrow_filled);
        } else {
            tvTitle.setText(R.string.backup_settings_title);
            tvDescription.setText(R.string.backup_settings_desc);
            ivIcon.setImageResource(R.drawable.ic_cloud_backup_arrow_filled);
            btnConfirm.setText(R.string.action_backup);
        }
