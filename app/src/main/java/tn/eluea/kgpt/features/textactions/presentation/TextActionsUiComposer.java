...
public class TextActionsUiComposer {
    ...
    private int getBackgroundColor() {
        switch (currentTheme) {
            ...
            default: // THEME_LIGHT
                ...
                context.getTheme().resolveAttribute(com.google.android.material.R.attr.colorSurfaceContainer,
                        typedValue, true);
    ...
    private int getOutlineColor() {
        switch (currentTheme) {
            ...
            default: // THEME_LIGHT
                TypedValue typedValue = new TypedValue();
                context.getTheme().resolveAttribute(com.google.android.material.R.attr.colorOutlineVariant, typedValue,
                        true);
                return typedValue.data;
        }
    }
    ...
    private int getSurfaceVariantColor() {
        switch (currentTheme) {
            ...
            default: // THEME_LIGHT
                TypedValue typedValue = new TypedValue();
                context.getTheme().resolveAttribute(com.google.android.material.R.attr.colorSurfaceVariant, typedValue,
                        true);
                return typedValue.data;
        }
    }
    ...
    private View createActionButton(TextAction action, boolean showLabel) {
        ...
        if (showLabel) {
            ...
            label.setText(action.getLabel(context));
