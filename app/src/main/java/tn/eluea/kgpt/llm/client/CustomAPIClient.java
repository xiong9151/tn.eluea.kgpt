...
public class CustomAPIClient extends LanguageModelClient {
    @Override
                    ...
                    (s, reader) -> {
                        ...
                        if (responseJson.has("error")) {
                            ...
                            if ("insufficient_quota".equals(code) || message.contains("quota")) {
                                userMessage = "API quota exceeded. Check your API billing or use a different model";
    ...
    public LanguageModel getLanguageModel() {
        return LanguageModel.CustomAPI;
    }
}