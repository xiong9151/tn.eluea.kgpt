...
public class InstalledAppsAdapter extends RecyclerView.Adapter<InstalledAppsAdapter.ViewHolder> {
    ...
    public void setSearchQuery(String query) {
        this.searchQuery = query.toLowerCase(java.util.Locale.ROOT).trim();
        applyFilters();
    }
    ...
    private void applyFilters() {
        ...
        for (InstalledApp app : allApps) {
            ...
            boolean passesSearch = searchQuery.isEmpty() ||
                    app.getAppName().toLowerCase(java.util.Locale.ROOT).contains(searchQuery) ||
                    app.getPackageName().toLowerCase(java.util.Locale.ROOT).contains(searchQuery);
